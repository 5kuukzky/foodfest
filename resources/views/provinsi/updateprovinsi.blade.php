    ...
    <div class="container">
        <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
            <div class="max-w-lg mx-auto">
                <h1 class="text-2xl font-bold text-center text-yellow-500 sm:text-3xl">Edit Provinsi </h1>
                ...
                <form action="" class="p-8 mt-6 mb-0 space-y-4 rounded-lg shadow-2xl" enctype="multipart/form-data"
                    ...
                    @endforeach
                    <div>
                        <label for="email" class="text-sm font-medium">Nama Provinsi</label>
                        <div class="relative mt-1">
                            <input type="text" id="text"
                                class="w-full p-4 pr-12 text-sm border-gray-200 rounded-lg shadow-sm"
                                placeholder="Nama Provinsi" name="nama" autocomplete="off"
                                value="{{ $provinsi->nama }}" />
                        </div>
                    </div>
                    ...
                    <div class="relative mt-1">
                        <input type="text" id="text"
                            class="w-full p-4 pr-12 text-sm border-gray-200 rounded-lg shadow-sm"
                            placeholder="Logo Provinsi" name="logo" autocomplete="off" value="{{ $provinsi->logo }}"
                            readonly />
                    </div>
